...
// Warna dibuat lebih bervariasi dan kontras untuk Pengeluaran
const COLORS: Record<string, string> = {
  Operasional: "#f43f5e", // Rose (Merah muda terang)
  Pembangunan: "#f59e0b", // Amber (Kuning keemasan)
  Sosial: "#10b981", // Emerald (Hijau terang)
  Honor: "#8b5cf6", // Violet (Ungu terang)
  Lainnya: "#64748b", // Slate (Abu-abu)
};

export default function FundUsageChart() {
